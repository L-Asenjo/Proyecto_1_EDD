...
public class ArrayList<T> implements IList<T> {
    ...
    @SuppressWarnings("unchecked")
    public ArrayList(IList<T> valor) {
        this.setTamInicial(DEFAULT_TAM_INICIAL);
        this.setTamBloque(DEFAULT_TAM_BLOQUE);
        this.tamLista = 0;
        arreglo = (T[]) new Object[tamInicial];
    ...
    /**
     * Inserta un array de elementos a la lista y devuelve un array de booleanos
     * con el resultado de la operación
     * 
     * @param valor el array a insertar
    ...
    /**
     * Inserta una lista de elementos a la lista y devuelve un array de booleanos
     * con el resultado de la operación
     * 
     * @param valor la lista a insertar
     * @return un array de booleanos
     */
    @Override
