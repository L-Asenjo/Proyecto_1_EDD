...
public class MenuPrincipalForm extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        Exit.setText("Cerrar Programa");
        Exit.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                ExitActionPerformed(evt);
            }
        });
        jPanel1.add(Exit, new org.netbeans.lib.awtextra.AbsoluteConstraints(120, 200, 140, -1));

        Archivos.setText("Seleccionar Red");
        Archivos.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                ArchivosActionPerformed(evt);
            }
        });
        jPanel1.add(Archivos, new org.netbeans.lib.awtextra.AbsoluteConstraints(120, 160, 140, -1));
